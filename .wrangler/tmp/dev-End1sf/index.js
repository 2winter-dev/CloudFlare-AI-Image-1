...
// .wrangler/tmp/bundle-cl5n6A/checked-fetch.js
...
// .wrangler/tmp/bundle-cl5n6A/strip-cf-connecting-ip-header.js
...
async function handleRequest(request, env) {
  ...
  let imagePrompt = url.searchParams.get("t");
  if (!imagePrompt) {
...
async function generateImageWithCloudflare(prompt, env) {
  const response = await fetch(`https://api.cloudflare.com/client/v4/accounts/${env.account_id}/ai/run/${env.CF_IMG2TEXT_MODEL}`, {
    ...
    body: JSON.stringify({
      model: env.CF_IMG2TEXT_MODEL,
      // 使用 Cloudflare 的模型生成图像
      prompt
...
__name(generateImageWithCloudflare, "generateImageWithCloudflare");
var index_default = {
...
// .wrangler/tmp/bundle-cl5n6A/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-cl5n6A/middleware-loader.entry.ts
